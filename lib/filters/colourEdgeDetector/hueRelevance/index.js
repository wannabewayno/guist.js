 ...
 * @param {Number} [options.smoothing=0.2] - [0,1] value of how sharp the step function is. 1 being a step, 0 being almost linear line
 * @param {Number} [options.midpoint=0.5] - [0,1] of where the midpoint is calculated from.
 */
